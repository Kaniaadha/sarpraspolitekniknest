...
function togglePenempatan(){
    ...
    let jenis = document.getElementById("jenis_penempatan").value;

    let boxRuangan = document.getElementById("box_ruangan");
    let boxPublic = document.getElementById("box_public");

    let selectRuangan = document.querySelector("select[name='id_ruangan']");
    let selectPublic = document.querySelector("select[name='id_public_space']");
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    document.getElementById("jenis_penempatan")
